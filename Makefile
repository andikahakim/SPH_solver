CXX = g++
CXXFLAGS = -Wall -std=c++17 -fopenmp -fpermissive ${OpenMP_C_FLAGS}
LDFLAGS =
SOURCE_DIR = src
...
$(BIN_DIR)/SPH_2D: $(BUILD_DIR)/SPH_2D.o $(BUILD_DIR)/SPH_PC_Snippet.o $(BUILD_DIR)/file_writer.o
	$(CXX) -fopenmp -o $@ $^
...
$(TEST_BIN_DIR)/test_SPH_2D: $(TEST_BUILD_DIR)/test_SPH_2D.o $(BUILD_DIR)/SPH_2D.o $(BUILD_DIR)/file_writer.o
	$(CXX) -o $@ $^ $(CXXFLAGS) $(CPPFLAGS) $(LDFLAGS) -I $(INCLUDE_DIR)

$(TEST_BIN_DIR)/test_file_writer: $(TEST_BUILD_DIR)/test_file_writer.o $(BUILD_DIR)/SPH_2D.o $(BUILD_DIR)/file_writer.o
	$(CXX) -o $@ $^ $(CXXFLAGS) $(CPPFLAGS) $(LDFLAGS) -I $(INCLUDE_DIR)
